...
class Config:
    ...
    DB_CONFIG: Dict[str, str] = {
        ...
        "password": os.getenv("DB_PASSWORD", "mmhy68mm")  # TODO: Move to env var in production!
    }
    
    # =================================================================
    # API CONFIGURATION
    # =================================================================
    API_KEY: str = os.getenv("ALPHA_VANTAGE_KEY", "KWKABB96U8N31TO4")  # TODO: Move to env var!
